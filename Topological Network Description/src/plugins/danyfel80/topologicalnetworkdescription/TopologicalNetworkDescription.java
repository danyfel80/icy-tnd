...
public class TopologicalNetworkDescription extends EzPlug {
  ...
  private EzVarSequence sequenceIn                      = new EzVarSequence(
      "Sequence");
  private EzVarInteger  thresholdIn                     = new EzVarInteger(
      "Threshold value");
  private EzVarInteger  inMinLabelingRadius             = new EzVarInteger(
  ...
  protected void execute() {
    ...
    // MessageDialog.INFORMATION_MESSAGE);
    System.out.println(
        "Segmentation Execution time : " + cpu.getCPUElapsedTimeSec() + "s.");
    ...
    // MessageDialog.INFORMATION_MESSAGE);
    System.out.println(
        "Distance Map Execution time : " + cpu.getCPUElapsedTimeSec() + "s.");
    ...
    // Execution time : " + cpu.getCPUElapsedTimeSec() + "s.",
    // MessageDialog.INFORMATION_MESSAGE);
    System.out.println("Cost Function to Seed Execution time : "
        + cpu.getCPUElapsedTimeSec() + "s.");
    ...
    System.out.println(
        "Endness Map Execution time : " + cpu.getCPUElapsedTimeSec() + "s.");
    ...
    // MessageDialog.INFORMATION_MESSAGE);
    System.out.println("Network Description Execution time : "
        + cpu.getCPUElapsedTimeSec() + "s.");
