...
import plugins.danyfel80.topologicalnetworkdescription.classes.CostToSeedCalculator;
...
import plugins.danyfel80.topologicalnetworkdescription.classes.Thresholder;
...
public class TopologicalNetworkDescription extends EzPlug {
	...
	protected void execute() {
		...
		Short threshold = thresholdIn.getValue().shortValue();
		...
		cpu.start();
		Sequence threshedSequence = Thresholder.process(SequenceUtil.convertToType(sequence, DataType.SHORT, false), threshold);
		cpu.stop();
...
//		// TODO Graph creation
//		NetworkDescriptionConstructor ndc = new NetworkDescriptionConstructor(endnessSequence, ctsc.getMinimumSpaningTree());
//		Sequence networkDescriptionSequence = ndc.process();
